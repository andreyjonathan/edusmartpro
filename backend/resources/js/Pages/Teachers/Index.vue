        ...
        <div class="overflow-x-auto">
          <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-slate-50">
              <tr v-for="teacher in teachers.data" :key="teacher.id" class="group hover:bg-slate-50/50 transition-colors">
                <td class="px-6 py-4">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <div class="text-sm font-bold text-slate-900">{{ teacher.name }}</div>
                      <div class="text-[11px] font-medium text-slate-400">{{ teacher.email || 'No email' }}</div>
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4 text-sm font-medium text-slate-600">{{ teacher.nip }}</td>
                <td class="px-6 py-4">
                  <div class="inline-flex px-2.5 py-1 rounded-lg bg-blue-50 text-blue-700 text-xs font-bold border border-blue-100">
                    {{ teacher.subject }}
                  </div>
                </td>
                <td class="px-6 py-4 text-sm font-medium text-slate-600">{{ teacher.gender }}</td>
                <td class="px-6 py-4">
                  <div 
                    :class="[
